def write_script(perm1,perm2,i):
    block1 = '''
<ParameterList name="Main" type="ParameterList">
  <ParameterList name="mesh" type="ParameterList">
    ...
    <ParameterList name="domain" type="ParameterList">
      ...
      <ParameterList name="read mesh file parameters" type="ParameterList">
        <Parameter name="file" type="string" value="../data/BSL_profile_thin.exo"/>
  ...
  <ParameterList name="regions" type="ParameterList">
    ...
    <ParameterList name="surface left" type="ParameterList">
      <ParameterList name="region: box" type="ParameterList">
        <Parameter name="low coordinate" type="Array(double)" value="{0.0, -0.5}"/>
        <Parameter name="high coordinate" type="Array(double)" value="{0.0, 0.5}"/>
      </ParameterList>
    </ParameterList>
    <ParameterList name="surface right" type="ParameterList">
      <ParameterList name="region: box" type="ParameterList">
        <Parameter name="low coordinate" type="Array(double)" value="{289.0, -0.5}"/>
        <Parameter name="high coordinate" type="Array(double)" value="{289.0, 0.5}"/>
      </ParameterList>
    </ParameterList>
    <ParameterList name="surface boundary" type="ParameterList">
      <ParameterList name="region: plane" type="ParameterList">
        <Parameter name="point" type="Array(double)" value="{289.0, 0.0}"/>
        <Parameter name="normal" type="Array(double)" value="{1.0, 0.0}"/>
      </ParameterList>
    </ParameterList>
    <ParameterList name="left_face" type="ParameterList">
      <ParameterList name="region: plane" type="ParameterList">
        <Parameter name="point" type="Array(double)" value="{0.0, 0.0, 0.0}"/>
        <Parameter name="normal" type="Array(double)" value="{-1.0, 0.0, 0.0}"/>
      </ParameterList>
    </ParameterList>
    <ParameterList name="right_face" type="ParameterList">
      <ParameterList name="region: plane" type="ParameterList">
        <Parameter name="point" type="Array(double)" value="{289.0, 0.0, 0.0}"/>
        <Parameter name="normal" type="Array(double)" value="{1.0, 0.0, 0.0}"/>
      </ParameterList>
    </ParameterList>
    <ParameterList name="Deciduous_surface" type="ParameterList">
      <ParameterList name="region: box" type="ParameterList">
        <Parameter name="low coordinate" type="Array(double)" value="{0.0, 0.0}"/>
        <Parameter name="high coordinate" type="Array(double)" value="{15.0, 1.0}"/>
      </ParameterList>
    </ParameterList>
    <ParameterList name="Open_surface" type="ParameterList">
      <ParameterList name="region: box" type="ParameterList">
        <Parameter name="low coordinate" type="Array(double)" value="{15.0, 0.0}"/>
        <Parameter name="high coordinate" type="Array(double)" value="{289.0, 1.0}"/>
      </ParameterList>
    </ParameterList>
  ...
  <ParameterList name="cycle driver" type="ParameterList">
    ...
    <Parameter name="end time" type="double" value="245.0"/>
    ...
    <ParameterList name="PK tree" type="ParameterList">
      <ParameterList name="water_balance" type="ParameterList">
        ...
        <ParameterList name="surface_subsurface_water" type="ParameterList">
          <Parameter name="PK type" type="string" value="coupled water"/>
          <ParameterList name="flow" type="ParameterList">
            <Parameter name="PK type" type="string" value="richards flow"/>
          </ParameterList>
          <ParameterList name="overland_flow" type="ParameterList">
  ...
  <ParameterList name="PKs" type="ParameterList">
    ...
    <ParameterList name="water_balance" type="ParameterList">
      <Parameter name="PK type" type="string" value="weak MPC"/>
      <Parameter name="PKs order" type="Array(string)" value="{canopy_water, snow, surface_subsurface_water}"/>
    ...
    <ParameterList name="surface_subsurface_water" type="ParameterList">
      <Parameter name="PK type" type="string" value="coupled water"/>
      <Parameter name="PKs order" type="Array(string)" value="{flow, overland_flow}"/>
    ...
    <ParameterList name="overland_flow" type="ParameterList">
      ...
      <ParameterList name="boundary conditions">
        ...
        <ParameterList name="seepage face head">
            <ParameterList name="surface right">
  ...
  <ParameterList name="state" type="ParameterList">
    <ParameterList name="evaluators" type="ParameterList">
      ...
      <ParameterList name="canopy-water_source_meters" type="ParameterList">
        ...
        <Parameter name="canopy-evaporation coefficient" type="double" value="-1.0"/>
        <Parameter name="canopy-drainage coefficient" type="double" value="-1.0"/>
      ...
      <ParameterList name="canopy-radiation_balance" type="ParameterList">
        ...
        <Parameter name="snow temperature key" type="string" value="snow-temperature"/>
        <Parameter name="canopy temperature key" type="string" value="canopy-temperature"/>
      ...
      <ParameterList name="snow-water_source_meters" type="ParameterList">
        ...
        <Parameter name="snow-evaporation coefficient" type="double" value="-1.0"/>
        <Parameter name="snow-melt coefficient" type="double" value="-1.0"/>
        <Parameter name="units" type="string" value="m s^-1"/>
      </ParameterList>
      ...
      <ParameterList name="snow-density">
        ...
        <Parameter name="value" type="double" value="150.0"/>
      ...
      <ParameterList name="surface-water_source" type="ParameterList">
        ...
        <Parameter name="surface-evaporation coefficient" type="double" value="-1.0"/>
        <Parameter name="units" type="string" value="m s^-1"/>
      </ParameterList>
      <ParameterList name="surface-evaporation" type="ParameterList">
        <Parameter name="evaluator type" type="string" value="evaporation downregulation, soil resistance"/>
        <Parameter name="units" type="string" value="m s^-1"/>
      </ParameterList>
      ...
      <ParameterList name="canopy-leaf_area_index" type="ParameterList">
        ...
        <ParameterList name="function" type="ParameterList">
          <ParameterList name="Deciduous_surface" type="ParameterList">
            <Parameter name="region" type="string" value="Deciduous_surface"/>
            <Parameter name="component" type="string" value="cell"/>
            <ParameterList name="function" type="ParameterList">
              <ParameterList name="function-tabular" type="ParameterList">
                <Parameter name="file" type="string" value="../data/LAI_data.h5"/>
                <Parameter name="x header" type="string" value="time [s]"/>
          ...
          <ParameterList name="Open_surface" type="ParameterList">
            <Parameter name="region" type="string" value="Open_surface"/>
            <Parameter name="component" type="string" value="cell"/>
            <ParameterList name="function" type="ParameterList">
              <ParameterList name="function-tabular" type="ParameterList">
                <Parameter name="file" type="string" value="../data/LAI_data.h5"/>
                <Parameter name="x header" type="string" value="time [s]"/>
                <Parameter name="y header" type="string" value="NLCD Developed, Medium Intensity LAI [-]"/>
              </ParameterList>
            </ParameterList>
          </ParameterList>
        </ParameterList>
      ...
      <ParameterList name="surface-incident_shortwave_radiation" type="ParameterList">
        ...
        <ParameterList name="incident shortwave radiation parameters" type="ParameterList">
          ...
          <Parameter name="latitude [degrees]" type="double" value="39.0"/>
        </ParameterList>
      </ParameterList>
      <ParameterList name="surface-incoming_shortwave_radiation" type="ParameterList">
        ...
        <ParameterList name="function" type="ParameterList">
          <ParameterList name="domain" type="ParameterList">
            ...
            <ParameterList name="function" type="ParameterList">
              <ParameterList name="function-tabular" type="ParameterList">
                <Parameter name="file" type="string" value="../data/daymet_dat.h5"/>
                <Parameter name="x header" type="string" value="time [s]"/>
        ...
        <ParameterList name="function" type="ParameterList">
          <ParameterList name="domain" type="ParameterList">
            ...
            <ParameterList name="function" type="ParameterList">
              <ParameterList name="function-tabular" type="ParameterList">
                <Parameter name="file" type="string" value="../data/daymet_dat.h5"/>
                <Parameter name="x header" type="string" value="time_precip [s]"/>
              ...
              <ParameterList name="function-composition" type="ParameterList">
                <ParameterList name="function2" type="ParameterList">
                  <ParameterList name="function-linear" type="ParameterList">
                    <Parameter name="x0" type="Array(double)" value="{86400.0, 0.0, 0.0}"/>
      ...
      <ParameterList name="base_porosity">
        ...
        <ParameterList name="function" type="ParameterList">
          ...
          <ParameterList name="NRCS_1001" type="ParameterList">
            ...
            <ParameterList name="function" type="ParameterList">
              <ParameterList name="function-constant" type="ParameterList">
                <Parameter name="value" type="double" value="0.423916287"/>
              </ParameterList>
            </ParameterList>
          </ParameterList>
        </ParameterList>
    ...
    block3='''
      ...
      <ParameterList name="snow-expected_temperature" type="ParameterList">
        ...
        <Parameter name="constant shift" type="double" value="-3.0"/>
      </ParameterList>
      <ParameterList name="snow-temperature" type="ParameterList">
        <Parameter name="evaluator type" type="string" value="secondary variable from function"/>
        <Parameter name="dependencies" type="Array(string)" value="{snow-expected_temperature}"/>
        <ParameterList name="function" type="ParameterList">
          <Parameter name="function type" type="string" value="composition"/>
          <ParameterList name="function1" type="ParameterList">
            <Parameter name="function type" type="string" value="linear"/>
            <Parameter name="gradient" type="Array(double)" value="{1.0}"/>
            <Parameter name="y0" type="double" value="273.15"/>
          </ParameterList>
          <ParameterList name="function2" type="ParameterList">
            <Parameter name="function type" type="string" value="standard math"/>
            <Parameter name="operator" type="string" value="negative"/>
            <Parameter name="shift" type="double" value="273.15"/>
          </ParameterList>
        </ParameterList>
      </ParameterList>
    ...
    <ParameterList name="model parameters" type="ParameterList">
      <ParameterList name="WRM parameters" type="ParameterList">
        ...
        <ParameterList name="NRCS_1000" type="ParameterList">
          <Parameter name="region" type="string" value="NRCS_1000"/>
          <Parameter name="wrm type" type="string" value="van Genuchten"/>
          <Parameter name="van Genuchten alpha [Pa^-1]" type="double" value="0.000049"/>
        ...
        <ParameterList name="NRCS_1001" type="ParameterList">
          ...
          <Parameter name="wrm type" type="string" value="van Genuchten"/>
          <Parameter name="van Genuchten alpha [Pa^-1]" type="double" value="0.000049"/>
          <Parameter name="van Genuchten n [-]" type="double" value="1.240693975"/>
          <Parameter name="residual saturation [-]" type="double" value="0.311210306"/>
          <Parameter name="smoothing interval width [saturation]" type="double" value="0.05"/>
          <Parameter name="dessicated zone thickness [m]" type="double" value="0.1"/>
        </ParameterList>
      </ParameterList>
      <ParameterList name="land cover types" type="ParameterList">
        <ParameterList name="Deciduous_surface" type="ParameterList">
          ...
          <Parameter name="Beer's law extinction coefficient, longwave [-]" type="double" value="5.0"/>
          <Parameter name="snow transition depth [m]" type="double" value="0.02"/>
        </ParameterList>
        <ParameterList name="Open_surface" type="ParameterList">
          <Parameter name="rooting depth max [m]" type="double" value="5.0"/>
          <Parameter name="rooting profile alpha [-]" type="double" value="11.0"/>
          <Parameter name="rooting profile beta [-]" type="double" value="2.0"/>
          <Parameter name="maximum xylem capillary pressure [Pa]" type="double" value="2750000.0"/>
          <Parameter name="leaf on time [doy]" type="double" value="-1.0"/>
          <Parameter name="leaf off time [doy]" type="double" value="-1.0"/>
          <Parameter name="Priestley-Taylor alpha of snow [-]" type="double" value="1.26"/>
          <Parameter name="Priestley-Taylor alpha of canopy [-]" type="double" value="1.26"/>
  ...
  <ParameterList name="checkpoint">
    <Parameter name="times start period stop" type="Array(double)" value="{0.0, 40.0, -1.0}"/>
    <Parameter name="times start period stop units" type="string" value="d"/>
    <Parameter name="time units" type="string" value="d"/>
  </ParameterList>
  ...
  <ParameterList name="observations" type="ParameterList">
    <ParameterList name="fluxes" type="ParameterList">
      ...
      <ParameterList name="observed quantities" type="ParameterList">
        ...
        <ParameterList name="subsurface seepage1 [mol d^-1]" type="ParameterList">
          <Parameter name="variable" type="string" value="water_flux"/>
          <Parameter name="direction normalized flux" type="bool" value="true"/>
          <Parameter name="region" type="string" value="left_face"/>
          <Parameter name="functional" type="string" value="extensive integral"/>
          <Parameter name="location name" type="string" value="face"/>
          <Parameter name="time integrated" type="bool" value="true"/>
        </ParameterList>
        <ParameterList name="subsurface seepage2 [mol d^-1]" type="ParameterList">
          <Parameter name="variable" type="string" value="water_flux"/>
          <Parameter name="direction normalized flux" type="bool" value="true"/>
          <Parameter name="region" type="string" value="right_face"/>
          <Parameter name="functional" type="string" value="extensive integral"/>
          <Parameter name="location name" type="string" value="face"/>
          <Parameter name="time integrated" type="bool" value="true"/>
        </ParameterList>
        ...
        '''
    with open('BSL_profile'+str(i)+'.xml', 'w') as f:
        f.write(block1)
